...
import { Title, Text, Grid, Badge } from '@mantine/core';

function Experience() {
  const experiences = [
    {
      period: 'Jul 2021 - Present',
      title: 'Software Engineer, Leidos',
  ...
  return (
    <>
      <Title style={{ color: "#248277", paddingBottom: "15px", fontFamily:'Space Mono' }} order={2}>Experience</Title>
      <Grid gutter="md">
        {experiences.map((experience, index) => (
          <React.Fragment key={index}>
            ...
            <Grid.Col span={8}>
              <Text weight={700} size="sm">{experience.title}</Text>
